...
public class InfiniteIntegerCalculatorFrame extends JFrame
{
	...
	private class ButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
			...
			{
				InfiniteInteger result = calculateResult();
	 ...
	 */
	private InfiniteInteger calculateResult()
	{
		...
		StackInterface<InfiniteInteger> resultStack = new LStack<InfiniteInteger>();
		...
		for(int i = 0; i < postFixSize; i++)
		{
			...
			if(temp.length() == 1 && isOperator(temp.charAt(0)))
			{
				 ...
				 * stack.
				 */
				InfiniteInteger op1, op2;		// operand 1 and 2
			...
			else
			{
				...
				resultStack.push(new InfiniteInteger(temp));
			}
		}
