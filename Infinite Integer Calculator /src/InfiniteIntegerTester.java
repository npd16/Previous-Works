...
public class InfiniteIntegerTester
{
	public static void main(String[] args)
	{
		...
		System.out.println("Welcome to Infinite Integer Tester");
		...
		InfiniteInteger gd1 = new InfiniteInteger("123456789");
		
		if(gd1.getNumberOfDigits() != 9)
		{
			System.out.println("FAIL");
			System.out.println("The integer 123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd1 = new InfiniteInteger(\"123456789\");");
		...
		InfiniteInteger gd2 = new InfiniteInteger("-123456789");
		
		if(gd2.getNumberOfDigits() != 9)
		{
			System.out.println("FAIL");
			System.out.println("The integer -123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd2 = new InfiniteInteger(\"-123456789\");");
			System.out.println("The integer -123456789 contains 9 digits.");
		...
		InfiniteInteger gd3 = new InfiniteInteger("000123456789");
		
		if(gd3.getNumberOfDigits() != 9)
		{
			System.out.println("FAIL");
			System.out.println("The integer 123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd3 = new InfiniteInteger(\"000123456789\");");
			System.out.println("The integer 123456789 contains 9 digits.");
		...
		InfiniteInteger gd4 = new InfiniteInteger("-000123456789");
		
		if(gd4.getNumberOfDigits() != 9)
		{
			System.out.println("FAIL");
			System.out.println("The integer -123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd4 = new InfiniteInteger(\"-000123456789\");");
			System.out.println("The integer -123456789 contains 9 digits.");
		...
		InfiniteInteger gd6 = new InfiniteInteger("0000");
		
		if(gd6.getNumberOfDigits() != 1)
		{
			System.out.println("FAIL");
			System.out.println("The integer 0 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd5 = new InfiniteInteger(\"0000\");");
			System.out.println("The integer 0 contains 1 digits.");
		...
		if(!gd6.toString().equals("0"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 0 was constructed using the following statement:");
			System.out.println("   InfiniteInteger gd6 = new InfiniteInteger(\"0000\");");
		...
		InfiniteInteger cp1 = new InfiniteInteger("987654321");
		
		if(cp1.compareTo(cp1) != 0)
		{
			System.out.println("FAIL");
			System.out.println("The integer 987654321 was constructed using the following statement:");
			System.out.println("   InfiniteInteger cp1 = new InfiniteInteger(\"987654321\");");
		...
		InfiniteInteger cp2 = new InfiniteInteger("123456789");
		...
		if(cp1.compareTo(cp2) != 1)
		{
			...
			System.out.println("   InfiniteInteger cp1 = new InfiniteInteger(\"987654321\");");
			System.out.println("The integer 123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger cp2 = new InfiniteInteger(\"123456789\");");
		...
		InfiniteInteger cp3 = new InfiniteInteger("123456789");
		...
		if(cp2.compareTo(cp3) != 0)
		{
			...
			System.out.println("   InfiniteInteger cp2 = new InfiniteInteger(\"123456789\");");
			System.out.println("The integer 123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger cp3 = new InfiniteInteger(\"123456789\");");
		...
		InfiniteInteger cp4 = new InfiniteInteger("-123456789");
		...
		if(cp3.compareTo(cp4) != 1)
		{
			...
			System.out.println("   InfiniteInteger cp3 = new InfiniteInteger(\"123456789\");");
			System.out.println("The integer -123456789 was constructed using the following statement:");
			System.out.println("   InfiniteInteger cp4 = new InfiniteInteger(\"-123456789\");");
		...
		for(int i = -500; i <= 500; i++)
		{
			for(int j = -500; j <= 500; j++)
			{
				...
				if(!((i + j) + "").equals(x.plus(y).toString()))
				{
					...
					System.out.println("   InfiniteInteger x = new InfiniteInteger(" + i + ");");
					System.out.println("InfiniteInteger y was constructed using the following statement:");
					System.out.println("   InfiniteInteger y = new InfiniteInteger(" + j + ");");
		...
		InfiniteInteger tp1 = new InfiniteInteger("12345678901234567890");
		if(!tp1.plus(tp1).toString().equals("24691357802469135780"))
		{
			...
			System.out.println("   InfiniteInteger tp1 = new InfiniteInteger(\"12345678901234567890\");");
		...
		InfiniteInteger tp2_1 = new InfiniteInteger("12345678901234567890");
		InfiniteInteger tp2_2 = new InfiniteInteger("-12345678901234567890");
		if(!tp2_1.plus(tp2_2).toString().equals("0"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 12345678901234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp2_1 = new InfiniteInteger(\"12345678901234567890\");");
			System.out.println("The integer -12345678901234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp2_2 = new InfiniteInteger(\"-12345678901234567890\");");
		...
		InfiniteInteger tp3_1 = new InfiniteInteger("100000000000000000000");
		InfiniteInteger tp3_2 = new InfiniteInteger("-1");
		if(!tp3_1.plus(tp3_2).toString().equals("99999999999999999999"))
		{
			...
			System.out.println("   InfiniteInteger tp3_1 = new InfiniteInteger(\"100000000000000000000\");");
			System.out.println("The integer -1 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp3_2 = new InfiniteInteger(\"-1\");");
		...
		InfiniteInteger tp4_1 = new InfiniteInteger("-1");
		InfiniteInteger tp4_2 = new InfiniteInteger("100000000000000000000");
		if(!tp4_1.plus(tp4_2).toString().equals("99999999999999999999"))
		{
			System.out.println("FAIL");
			System.out.println("The integer -1 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp4_1 = new InfiniteInteger(\"-1\");");
			System.out.println("The integer 100000000000000000000 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp4_2 = new InfiniteInteger(\"100000000000000000000\");");
		...
		System.out.print("Calculating 1 + (-100000000000000000000): ");
		InfiniteInteger tp5_1 = new InfiniteInteger("1");
		InfiniteInteger tp5_2 = new InfiniteInteger("-100000000000000000000");
		if(!tp5_1.plus(tp5_2).toString().equals("-99999999999999999999"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 1 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp5_1 = new InfiniteInteger(\"1\");");
			System.out.println("The integer -100000000000000000000 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp5_2 = new InfiniteInteger(\"-100000000000000000000\");");
			System.out.println("The result of 1 + (-100000000000000000000) should be -99999999999999999999.");
		...
		System.out.print("Calculating (-100000000000000000000) + 1: ");
		InfiniteInteger tp6_1 = new InfiniteInteger("-100000000000000000000");
		InfiniteInteger tp6_2 = new InfiniteInteger("1");
		if(!tp6_1.plus(tp6_2).toString().equals("-99999999999999999999"))
		{
			System.out.println("FAIL");
			System.out.println("The integer -100000000000000000000 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp6_1 = new InfiniteInteger(\"-100000000000000000000\");");
			System.out.println("The integer 1 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tp6_2 = new InfiniteInteger(\"1\");");
			System.out.println("The result of (-100000000000000000000) + 1 should be -99999999999999999999.");
		...
		InfiniteInteger tm1 = new InfiniteInteger("12345678901234567890");
		...
		if(!tm1.minus(tm1).toString().equals("0"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 12345678901234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tm1 = new InfiniteInteger(\"12345678901234567890\");");
			System.out.println("The result of 12345678901234567890 - 12345678901234567890 should be 0.");
		...
		InfiniteInteger tm2_1 = new InfiniteInteger("12345678901234567890");
		InfiniteInteger tm2_2 = new InfiniteInteger("1234567890");
		...
		if(!tm2_1.minus(tm2_2).toString().equals("12345678900000000000"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 12345678901234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tm2_1 = new InfiniteInteger(\"12345678901234567890\");");
			System.out.println("The integer 1234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tm2_2 = new InfiniteInteger(\"1234567890\");");
		...
		InfiniteInteger tm3_1 = new InfiniteInteger("1234567890");
		InfiniteInteger tm3_2 = new InfiniteInteger("12345678901234567890");
		...
		if(!tm3_1.minus(tm3_2).toString().equals("-12345678900000000000"))
		{
			System.out.println("FAIL");
			System.out.println("The integer 1234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tm3_1 = new InfiniteInteger(\"1234567890\");");
			System.out.println("The integer 12345678901234567890 was constructed using the following statement:");
			System.out.println("   InfiniteInteger tm3_2 = new InfiniteInteger(\"12345678901234567890\");");
		...
		InfiniteInteger tml1 = new InfiniteInteger("12345678901234567890");
		...
		if(!tml1.multiply(tml1).toString().equals(tml1Result))
		{
			...
			System.out.println("   InfiniteInteger tml1 = new InfiniteInteger(\"12345678901234567890\");");
		...
		InfiniteInteger tml2 = new InfiniteInteger("-12345678901234567890");
		...
		if(!tml1.multiply(tml2).toString().equals("-" + tml1Result))
		{
			...
			System.out.println("   InfiniteInteger tml2 = new InfiniteInteger(\"-12345678901234567890\");");
		...
		InfiniteInteger tml0 = new InfiniteInteger("0");
		...
		if(!tml1.multiply(tml0).toString().equals("0"))
		{
			...
			System.out.println("   InfiniteInteger tml0 = new InfiniteInteger(\"0\");");
		...
		InfiniteInteger tml3 = tml1.multiply(tml0);
		...
		if(tml3.compareTo(tml0) != 0)
		{
			...
			System.out.println("   InfiniteInteger tml3 = tml1.multiply(tml0);");
		...
		System.out.println("   InfiniteInteger x = new InfiniteInteger(\"1\");");
		...
		{
			InfiniteInteger x = new InfiniteInteger("1");
		...
		InfiniteInteger crazy = new InfiniteInteger("1");
		int result = 0;
